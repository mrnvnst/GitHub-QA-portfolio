...
#### Название:
Проверка логики кнопки бронирования при заполнении всех обязательных полей формы бронирования и адресов. 
...
**Ожидаемый результат:**  
- Текст на кнопке: "Забронировать Маршрут составит n км и займет n мин".
...
**Title:**
Verify booking button logic when all required booking form fields and addresses are filled.
...
7. Remove the address from the “From” field.
8. Remove the address from the “To” field.
9. Click the "Book" button.

**Expected result:**  
- The booking button displays the text:
“Book. The route will be n km and will take n minutes.”
