### BR-003 – Система позволяет вводить невалидные символы в поле «Номер карты»
...
2. В форме добавления карты ввести в поле «Номер карты» значение:
746296АД5837

**Ожидаемый результат:**  
Система не принимает невалидные символы и автоматически сбрасывает ввод в поле «Номер карты».

**Фактический результат:**  
Введённые невалидные символы остаются в поле «Номер карты».
...
- Скриншот:
    ...
    ![BR-003 Screenshot](../attachments/BR-003-invalid-characters-card-number.png)

---

### BR-003 – The system allows entering invalid characters into the “Card number” field
